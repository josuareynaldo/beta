...
<html lang="en">
  ...
  <body>    
      ...
      <div class="headerr">
        <h4 style="color: black; font-family: calibri; text-align: left">TRIAL RESULT FORM</h4>
        <hr style="border-style: solid;">
      </div>


      <div style="width:auto;height:auto;border:2px solid #000; font-family: calibri;">NO 00<?php echo $trial_req->trial_no ?>/VII/TECH-RESULT/<?php echo date("Y") ?> </div>
